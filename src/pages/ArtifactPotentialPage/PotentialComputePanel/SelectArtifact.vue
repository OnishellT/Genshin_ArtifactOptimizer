...
export default {
    ...
    created: function () {
        this.artifactsType = [
            { name: "flower", chs: "Flower", iconURL: artifactsIcon["flower"] },
            { name: "feather", chs: "Feather", iconURL: artifactsIcon["feather"] },
            { name: "sand", chs: "Sands", iconURL: artifactsIcon["sand"] },
