...
function computeArtifacts(artifacts, configObject) {
    ...
    if (maxRecord.length === 0) {
        return {
            error: {
                reason:
                    "There is no artifact that meets the conditions, please carefully check the filter conditions, restrictions (sets, etc.), and whether there are errors in the import of artifacts",
                code: 1000,
                isError: true,
            },
        };
